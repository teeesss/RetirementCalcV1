...
window.onerror = function (message, source, lineno, colno, error) {
  ...
  div.style.cssText = 'position:fixed;top:0;left:0;width:100%;background:red;color:white;padding:20px;z-index:9999;font-family:sans-serif;';
...
window.onunhandledrejection = function (event) {
  const div = document.createElement('div');
  div.style.cssText = 'position:fixed;top:50px;left:0;width:100%;height:200px;background:darkred;color:white;padding:20px;z-index:9999;font-family:sans-serif;overflow:auto;border-bottom:4px solid white;';
...
signal.style.cssText = 'position:fixed;bottom:0;right:0;width:10px;height:10px;background:lime;z-index:9999;pointer-events:none;';
