...
export default function EfficiencyDashboard() {
  ...
  if (!ledger || !metrics)
    return <div className="p-8 text-center text-gray-500">No plan data available.</div>;
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start">
                ...
                <span>
                  Your strategy prioritizes <strong>Standard Deduction</strong> filling first (0%
                  tax).
                </span>
              </li>
              <li className="flex items-start">
              ...
              {planData.taxOptimization?.enableRothConversion && (
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Roth Conversions</strong> are active, filling up to the{' '}
                    {((planData.taxOptimization.rothConversionTargetBracket || 0.12) * 100).toFixed(
                      0
                    )}
                    % bracket.
                  </span>
      ...
      {viewMode === 'table' && <WithdrawalSourceTable ledger={ledger} />}
    </div>
  );
}
