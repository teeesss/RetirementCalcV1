...
const EstateSettings = () => {
    ...
    const removeSpecificBequest = (id) => {
        const currentRecipients = estate.bequest?.specific || [];
        updateEstate('bequest', { ...estate.bequest, specific: currentRecipients.filter(r => r.id !== id) });
    };
        ...
        <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                            Move life insurance policies into a trust to exclude proceeds from factors determining Estate Tax liability.
                        </p>
                        {estate.ilit?.enabled && (
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700 col-span-1 md:col-span-2">
                        <div className="flex justify-between items-center mb-4">
                            <div>
                                <h3 className="font-semibold text-gray-700 dark:text-gray-200">Specific Bequests (Cash Gifts)</h3>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Fixed dollar amounts distributed *before* the residual split.</p>
                            </div>
                            <button
                                ...
                                <div key={item.id} className="flex items-center gap-3">
                                    ...
                                    <div className="relative w-40">
                                        ...
                                        <input
                                            ...
                                            placeholder="Amount"
                                            value={item.amount}
                                            onChange={(e) => updateSpecificBequest(item.id, 'amount', Number(e.target.value))}
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                    <h3 className="text-md font-semibold text-gray-800 dark:text-gray-200 mb-4">Projected Legacy Flow (End of Plan)</h3>
