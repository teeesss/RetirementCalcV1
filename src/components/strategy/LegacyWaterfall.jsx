    ...
    datasets: [
      {
        ...
        borderColor: ['#059669', '#D97706', '#2563EB', '#DC2626', '#4B5563'],
        borderWidth: 1,
      },
    ],
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <div className="text-[10px] text-gray-400 mt-1">Mortgage & HECM</div>
        </div>
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/10 p-4 rounded-lg border border-emerald-100 dark:border-emerald-800/30 shadow-sm">
          ...
          <p className="text-xl font-bold text-emerald-700 dark:text-emerald-300">
            {fmt(net.heirs + net.charity + (net.specific || 0))}
          </p>
          <div className="text-[10px] text-emerald-600/70 mt-1">
            Efficiency:{' '}
            {(((net.heirs + net.charity + (net.specific || 0)) / grossTotal) * 100).toFixed(1)}%
          </div>
        </div>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-1.5">
              <div
                ...
                style={{ width: `${(gross.portfolio / grossTotal) * 100}%` }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-1.5">
              <div
                ...
                style={{ width: `${(gross.realEstate / grossTotal) * 100}%` }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-1.5">
              <div
                ...
                style={{ width: `${(gross.insurance / grossTotal) * 100}%` }}
              ></div>
            </div>
          </div>
        </div>
